...
python3 -c "from tests0 import test_prime; test_prime(8, True)"
python3 -c "from tests0 import test_prime; test_prime(11, True)"
python3 -c "from tests0 import test_prime; test_prime(25, True)"
python3 -c "from tests0 import test_prime; test_prime(28, False)"
python3 -c "from tests0 import test_prime; test_prime(7, False)"